...
export default function LoginPage() {
  ...
  useEffect(() => {
    setCampaignSlug(new URLSearchParams(window.location.search).get('campaign'));
  }, []);
  ...
  return campaignSlug
    ? <PublicCampaignTheme campaignSlug={campaignSlug}>{content}</PublicCampaignTheme>
    : <CampaignThemeProvider>{content}</CampaignThemeProvider>;
}
